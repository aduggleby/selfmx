    ...
    return (
      <button
        className={cn(
          ...
          {
            'bg-primary text-primary-foreground focus-visible:ring-primary/50': variant === 'default',
            'bg-destructive text-destructive-foreground focus-visible:ring-destructive/50': variant === 'destructive',
            'border border-border/70 bg-background hover:bg-accent hover:text-accent-foreground hover:border-border focus-visible:ring-ring': variant === 'outline',
            ...
            'hover:bg-accent/70 hover:text-accent-foreground focus-visible:ring-ring': variant === 'ghost',
